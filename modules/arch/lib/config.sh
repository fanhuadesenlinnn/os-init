...
PROXY_AUTO_ENABLE_SERVICE SING_BOX_PACKAGE SING_BOX_CONFIG_DIR SING_BOX_CONFIG_FILE SING_BOX_CONFIG_SOURCE SING_BOX_MIXED_PORT
EOF
}
...
VMWARE_FORCE_SOFTWARE_RENDERER VM_HYPRLAND_DYNAMIC_RESIZE VM_HYPRLAND_LOW_LATENCY INSTALL_HYPRDOTS_OBSIDIAN PROXY_AUTO_ENABLE_SERVICE
EOF
}
